...
const file_conformance_proto_rawDesc = "" +
	...
	"\n" +
	"BidiStream\x12..grpc.webnext.conformance.v1.BidiStreamRequest\x1a/.grpc.webnext.conformance.v1.ConformancePayload\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/bidi-stream(\x010\x01\x12\xea\x01\n" +
	"\tRestUnary\x12-.grpc.webnext.conformance.v1.RestUnaryRequest\x1a/.grpc.webnext.conformance.v1.ConformancePayload\"}\x82\xd3\xe4\x93\x02wZ\r:\x01*\"\b/v1/restZ\x17:\x01*\"\x12/v1/rest/{payload}Z\x1b\x12\x19/v1/rest/skip/*/{payload}Z\x1c\x12\x1a/v1/rest/tail/{payload}/**\x12\x12/v1/rest/{payload}\x12\x98\x01\n" +
